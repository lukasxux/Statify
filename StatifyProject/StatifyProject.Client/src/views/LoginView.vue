...
<div class="container" id="container">
    ...
    <form action="#">
      ...
      <input type="text" placeholder="Username" v-model="regmodel.regUsername"/>
			<input type="email" placeholder="Email" v-model="regmodel.regEmail"/>
			<input type="password" placeholder="Password" v-model="regmodel.regPassword"/>
			<input @click="linkSpotifyAcc" type="button" value="Link your Spotfiy Account" v-if="!isLinked" style="border-radius: 5px; display:flex; justify-content: left; color: ##9EB6CE">
      <input @click="linkSpotifyAcc" type="button" value="Spotify Account Linked!" v-else style="border-radius: 5px; display:flex; justify-content: left; color: #222" disabled>
